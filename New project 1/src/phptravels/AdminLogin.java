...
public class AdminLogin {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Thread.sleep(3000);
		driver.findElement(By.xpath("//button[@type='submit']")).click();
		driver.findElement(By.name("hotelname")).sendKeys("Soumya_15:53");
		Thread.sleep(3000);
		...
		boolean elePresent=driver.findElement(By.xpath("//a[text()='Soumya_15:53']")).isDisplayed();
		System.out.print("Hotel name  Soumya_15:5 is added : " + elePresent);
